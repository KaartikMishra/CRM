...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn('flex size-full flex-col overflow-hidden rounded-md bg-surface text-ink', className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <div className="flex items-center gap-2 border-b border-line px-3">
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        'flex h-10 w-full bg-transparent py-3 text-sm outline-none placeholder:text-faint',
        className,
      )}
      {...props}
    />
...
>((props, ref) => (
  <CommandPrimitive.Empty ref={ref} className="px-3 py-6 text-center text-sm text-muted" {...props} />
));
